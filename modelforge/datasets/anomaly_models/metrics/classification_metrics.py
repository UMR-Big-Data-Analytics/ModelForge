...
class ClassificationMetric(Metric, ABC):
    ...
    require a thresholding strategy to convert anomaly_models scorings to binary classification results. The thresholding
...
class Precision(ClassificationMetric):
    ...
    thresholding_strategy : ThresholdingStrategy
        Thresholding strategy used to transform the anomaly_models scorings to binary classification predictions.
