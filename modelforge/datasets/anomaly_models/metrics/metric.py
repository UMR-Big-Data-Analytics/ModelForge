...
class Metric(ABC):
    """Base class for metric implementations that score anomaly_models scorings against ground truth binary labels. Every
    ...
    @abstractmethod
    def supports_continuous_scorings(self) -> bool:
        """Whether this metric accepts continuous anomaly_models scorings as input (``True``) or binary classification
        labels (``False``)."""
        ...
