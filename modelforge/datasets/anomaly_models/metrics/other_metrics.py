...
class FScoreAtK(Metric):
    """Computes the F-score at k based on anomaly_models ranges.

    This metric only considers the top-k predicted anomaly_models ranges within the scoring by finding a threshold on the
    scoring that produces at least k anomaly_models ranges.
...
class PrecisionAtK(Metric):
    """Computes the Precision at k based on anomaly_models ranges.
